...
import {
  ...
  setSelectedBoard,
  addCardToList } from '../../services/Boards/BoardsActionCreators.js';
import { getBoardsFromLS, setBoardsOnLS, setallBoardIdsOnLS, getallBoardIdsFromLS, getSelectedBoardIdFromLS, setSelectedBoardIdOnLS } from '../../utils/localStorage.js';
import DefaultDataJs from './defaultData.js';
import classnames from 'classnames';
import HeadingField from '../../components/HeadingField.jsx';
...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    if(!getBoardsFromLS()) {
      console.log('intel ==> DefaultDataJs', DefaultDataJs)
